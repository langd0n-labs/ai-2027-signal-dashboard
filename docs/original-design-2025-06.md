...
## 🧠 GenAI Analyst Options

### ✅ ChatGPT
* Best for infrastructure scaffolding, scripting, prompting, and analysis of short or structured content
* Used via API to classify trends from scraped summaries

### ✅ Claude (Haiku or Opus)
* Ideal for longform or nuanced synthesis of multiple articles or datasets
* Works well with structured prompts and JSON output

Both options are supported; you can toggle which analyst to use via the pipeline script or action config.
...
* Cursor was considered for developer IDE integration but is not required.
